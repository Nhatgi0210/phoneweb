...
<div class="container2">
    ...
    <div class="personal-info">
        ...
        <form>
            ...
            <input type="text" value="Nguyễn Linh" readonly class="input2">

            <label>Số điện thoại:</label>
            <input type="text" value="0389678123"class="input2">

            <label>Gmail:</label>
            <input type="text" value="linh333@gmail.com"class="input2">

            <label>Địa chỉ :</label>
            <input type="text" value="Trường Việt Hàn-ĐHĐN" readonly class="input2">
            <button type="submit" class="button2">Cập nhật thông tin</button>
            <button class="button2">Đổi mật khẩu</button>
        </form>
    </div>
</div>
@endsection
