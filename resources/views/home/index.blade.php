...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <video class="video-overlay d-block w-100" autoplay loop muted>
                        <source src="{{ asset('frontend/img/trailerss.webm') }}" type="video/mp4">
                      </video>
                ...
                <div class="carousel-item">
                    <video class="video-overlay d-block w-100" autoplay loop muted>
                        <source src="{{ asset('frontend/img/trailerip15.mp4') }}" type="video/mp4">
                      </video>
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
    ...
    <script>
        document.querySelectorAll('.formatted-number').forEach(function(element) {
            let number = parseInt(element.textContent, 10); // Lấy số từ nội dung của phần tử
            element.textContent = number.toLocaleString('vi-VN'); // Format theo kiểu Việt Nam
        });
    </script>
</body>
